...
const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    tab: 'Accounts',
    title: 'Accounts',
    body: 'This page shows your connected accounts with quick add and sync actions.',
  },
  {
    id: 'accounts-connect',
    tab: 'Accounts',
    title: 'Final step: connect your account',
    body: 'Tap Add account to link your first institution and start transaction syncing.',
